...
const Pantry = ({items, setItems}) => {
    ...
    return (
        <div className="chore-list">
            ...
            <Popup onOpen={event => {d(""); expdate("")} } trigger={<IconButton color="primary"><AddCircleIcon/></IconButton>} modal nested>
                <form onSubmit={handleSubmit}>
                    <label for="name">
                        <p>Name:</p>
                        <input type="text" name="name" onChange={event => d(event.target.value)}></input>
                    </label>
